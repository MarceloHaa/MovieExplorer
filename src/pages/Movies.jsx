...
function Movies() {
    ...
    const { useSearchMovies, useMovieDetails } = useMovies();

    const {
        data: movies,
        isLoading: isSearching,
        error: searchError,
    } = useSearchMovies(activeSearch);
        ...
        <div className={styles.container}>
            ...
            <form onSubmit={handleSearch} className={styles.searchForm}>
                ...
                <button type="submit" className={styles.button}>
                    ...
                    <span className={styles.text_button}>Buscar</span>
                </button>
            </form>

            {searchError && (
                <p className={styles.error}>
                    Erro ao buscar filmes: {searchError.message}
                </p>
            )}
            ...
            <div className={styles.content}>
                ...
                {isLoadingDetails && selectedMovieId && (
